...
Estruturação Semântica: Uso correto de tags HTML5.

Estilização Avançada: Flexbox e CSS Grid para layouts complexos.

Responsividade: Adaptação da interface para diferentes tamanhos de tela (Mobile First).
...
Implementei a inclusão do ícone da Netflix em ambas as páginas do projeto (Landing Page e Página de Navegação), garantindo que a identidade visual seja mantida na aba do navegador.

2. Seletor de Idiomas (Toggle Language)

Adicionei um componente funcional de troca de idioma no cabeçalho.
...
Projeto desenvolvido com fins educativos por Anna Carolina de Miranda A. D. Couto.
